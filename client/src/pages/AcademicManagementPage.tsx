...
export default function AcademicManagementPage() {
  ...
  return <PortalLayout role={profile.role}><main className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8"><div className="grid gap-6"><AcademicDirectory /><TeacherAssignmentsDirectory /></div></main></PortalLayout>;
}