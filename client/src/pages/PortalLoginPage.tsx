...
export default function PortalLoginPage() {
  ...
  const switchMode = (next: "signin" | "register") => { setMode(next); setMessage(""); setPassword(""); setConfirmPassword(""); setEmail(""); };
