...
export default function AdminOperationsPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const [yearRes, termRes, studentsRes, summaryRes, sessionsRes, recordsRes, eventsRes, noticesRes] = await Promise.all([
      ...
      for (const result of [yearRes, termRes, studentsRes, summaryRes, sessionsRes, recordsRes, eventsRes, noticesRes]) if (result.error) throw result.error;
